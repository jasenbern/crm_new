...
<body class="main">
	...
	<form:form id="chanceForm" action="${ctp}/chance/dispatch/" method="post" modelAttribute="chance">
		<form:hidden path="id"/>
		...
		<table class="query_form_table" border="0" cellPadding="3" cellSpacing="0">				
			<tr>					
				<th>指派给</th>
				<td>
					<form:select path="designee.id" items="${users }" itemLabel="name" itemValue="id"></form:select>
