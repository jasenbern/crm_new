...
<html>
  ...
  <div class="button_bar">
	...
	<button class="common_button" onclick="document.forms[0].submit();">保存AJAX</button>
  </div>
	  ...
	  <form action="${ctp }/drain/delay/${drain.id}" method="POST">
			...
			<table class="query_form_table" border="0" cellPadding="3" cellSpacing="0">
				...
				<tr>
					...
					<th>最后一次下单时间</th>
					<td>
						<c:if test="${drain.lastOrderDate != null}">
				...
				<tr>
					<th>追加暂缓措施</th>
					<td colspan="3"><textarea name="delayAdd" cols="50" rows="6"></textarea>&nbsp;</td>
				</tr>
			</table>
	   </form>	
  </body>
